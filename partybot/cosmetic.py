...
class CosmeticCommands(commands.Cog):
    ...
    async def set_vtid1(self, variant_token: str) -> Tuple[str, str, int]:
    ...
    async def skin(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            ...
            await ctx.send(f"Не удалось найти скин: {content}.")
            print(self.bot.message % f"Не удалось найти скин: {content}.")
    ...
    async def backpack(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            ...
            await ctx.send(f'Украшение на спину установлено: {cosmetic.id}.')
            print(self.bot.message % f"Украшение на спину установлено: {cosmetic.id}.")
            await self.bot.party.me.set_backpack(asset=cosmetic.id)

        except FortniteAPIAsync.exceptions.NotFound:
            await ctx.send(f"Не удалось найти украшение на спину: {content}.")
            print(self.bot.message % f"Не удалось найти украшение на спину: {content}.")
    ...
    async def emote(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            ...
            await ctx.send(f'Эмоция установлена: {cosmetic.id}.')
            print(self.bot.message % f"Эмоция установлена: {cosmetic.id}.")
            await self.bot.party.me.clear_emote()
            await self.bot.party.me.set_emote(asset=cosmetic.id)

        except FortniteAPIAsync.exceptions.NotFound:
            await ctx.send(f"Не удалось найти эмоцию: {content}.")
            print(self.bot.message % f"Не удалось найти эмоцию: {content}.")
    ...
    async def pickaxe(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            ...
            await ctx.send(f'Кирка установлена: {cosmetic.id}.')
            print(self.bot.message % f"Кирка установлена: {cosmetic.id}.")
            await self.bot.party.me.set_pickaxe(asset=cosmetic.id)

        except FortniteAPIAsync.exceptions.NotFound:
            await ctx.send(f"Не найдена кирка: {content}.")
            print(self.bot.message % f"Не найдена кирка: {content}.")
    ...
    async def pet(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            ...
            await ctx.send(f"Не удалось найти питомца: {content}.")
            print(self.bot.message % f"Не удалось найти питомца:{content}.")
    ...
    async def contrail1(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            cosmetic = await self.bot.fortnite_api.cosmetics.get_cosmetic(
                lang="en",
                searchLang="en",
    ...
    async def purpleskull1(self, ctx: fortnitepy.ext.commands.Context) -> None:
    ...
    async def pinkghoul1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        skin_variants = self.bot.party.me.create_variants(
            material=3
        )
    ...
    async def purpleportal1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        skin_variants = self.bot.party.me.create_variants(
            item='AthenaBackpack',
    ...
    async def cid1(self, ctx: fortnitepy.ext.commands.Context, character_id: str) -> None:
        await self.bot.party.me.set_outfit(
            asset=character_id,
    ...
    async def vtid1(self, ctx: fortnitepy.ext.commands.Context, variant_token: str) -> None:
    ...
    async def variants1(self, ctx: fortnitepy.ext.commands.Context, cosmetic_id: str, variant_type: str,
    ...
    async def checkeredrenegade1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        skin_variants = self.bot.party.me.create_variants(
            material=2
        )
    ...
    async def mintyelf1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        skin_variants = self.bot.party.me.create_variants(
            material=2
        )
    ...
    async def eid1(self, ctx: fortnitepy.ext.commands.Context, emote_id: str) -> None:
        await self.bot.party.me.clear_emote()
    ...
    async def stop(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.clear_emote()
        await ctx.send('Остановка эмоции.')
        print(self.bot.message % f'Остановка эмоции.')
    ...
    async def bid1(self, ctx: fortnitepy.ext.commands.Context, backpack_id: str) -> None:
        await self.bot.party.me.set_backpack(
            asset=backpack_id
        )
    ...
    async def pickaxe_id1(self, ctx: fortnitepy.ext.commands.Context, pickaxe_id_: str) -> None:
        await self.bot.party.me.set_pickaxe(
            asset=pickaxe_id_
        )
    ...
    async def pet_carrier1(self, ctx: fortnitepy.ext.commands.Context, pet_carrier_id: str) -> None:
    ...
    async def emoji_id1(self, ctx: fortnitepy.ext.commands.Context, emoji_: str) -> None:
        await self.bot.party.me.clear_emote()
    ...
    async def trails1(self, ctx: fortnitepy.ext.commands.Context, trails_: str) -> None:
    ...
    async def point1(self, ctx: fortnitepy.ext.commands.Context, *, content: Optional[str] = None) -> None:
        if content is None:
    ...
    async def copy1(self, ctx: fortnitepy.ext.commands.Context, *, epic_username: Optional[str] = None) -> None:
    ...
    async def hologram1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def ninja1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def rareskins1(self, ctx: fortnitepy.ext.commands.Context) -> None:
    ...
    async def goldenpeely1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def random(self, ctx: fortnitepy.ext.commands.Context, cosmetic_type: str = 'skin') -> None:
        if cosmetic_type == 'skin':
            ...
            await ctx.send(f'Установлен рандомный скин: {random_skin}.')
            print(self.bot.message % f"Установлен рандомный скин: {random_skin}.")
            ...
            await ctx.send(f'Установлено рандомное украшение:  {random_backpack}.')
            print(self.bot.message % f"Установлено рандомное украшение: {random_backpack}.")
            ...
            await ctx.send(f'Установлена рандомная эмоция: {random_emote}.')
            print(self.bot.message % f"Установлена рандомная эмоция:{random_emote}.")
            ...
            await ctx.send(f'Установлен рандомный скин: {random_outfit}.')
            print(self.bot.message % f"Установлен рандомный скин: {random_outfit}.")
    ...
    async def nobackpack(self, ctx: fortnitepy.ext.commands.Context) -> None:
        ...
        await ctx.send('Украшение на спину убрано.')
    ...
    async def nocontrail1(self, ctx: fortnitepy.ext.commands.Context) -> None:
    ...
    async def ghost1(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            skin_variants = self.bot.party.me.create_variants(
                progressive=2
            )
    ...
    async def shadow1(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        try:
            skin_variants = self.bot.party.me.create_variants(
                progressive=3
            )
    ...
    async def style1(self, ctx: fortnitepy.ext.commands.Context, cosmetic_name: str, variant_type: str,
                    variant_int: str) -> None:
        # cosmetic_types = {
        #     "AthenaCharacter": self.bot.party.me.set_outfit,
        #     "AthenaBackpack": self.bot.party.me.set_backpack,
    ...
    async def new1(self, ctx: fortnitepy.ext.commands.Context, cosmetic_type: str = 'skin') -> None:
        cosmetic_types = {
            'skin': {
                'id': 'cid_',
    ...
    async def shop1(self, ctx: fortnitepy.ext.commands.Context) -> None:
    ...
    async def olddefault1(self, ctx: fortnitepy.ext.commands.Context) -> None:
    ...
    async def hatlessrecon1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        skin_variants = self.bot.party.me.create_variants(
            parts=2
        )
    ...
    async def henchman1(self, ctx: fortnitepy.ext.commands.Context) -> None:
    ...
    async def marauder1(self, ctx: fortnitepy.ext.commands.Context) -> None:
    ...
    async def goldenbrutus1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def goldenmeowscles1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def goldenmidas1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def goldenskye1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def goldentntina1(self, ctx: fortnitepy.ext.commands.Context) -> None:
        await self.bot.party.me.set_outfit(
    ...
    async def login(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
    	await ctx.send(f"Вы авторизовались под данными: {content}.")
    	print(self.bot.message % f"Данные авторизации: {content}.")
