...
class ClientCommands(commands.Cog):
    ...
    async def status(self, ctx: fortnitepy.ext.commands.Context, *, content: str) -> None:
        ...
        await ctx.send(f'Статус установлен: {content}')
        print(self.bot.message % f'Статус установлен: {content}.')
    ...
    async def clean(self, ctx: fortnitepy.ext.commands.Context) -> None:
        ...
        print(crayons.cyan(self.bot.message % f'Made by Selli324 '))
        print(crayons.cyan(
            self.bot.message % f''))
    ...
    async def away(self, ctx: fortnitepy.ext.commands.Context) -> None:
        ...
        await ctx.send('Установлен статус: Нет на месте.')
        print(self.bot.message % f'Установлен статус: Нет на месте.')
